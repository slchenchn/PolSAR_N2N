...
def MV3_1_true_2_ResNet50_syncbn(num_classes, pretrained=True, **kwargs):
...
def MV3_1_true_2_ResNet101_syncbn(num_classes, pretrained=False, **kwargs):
...
def MV3_1_true_2_ResNet152_syncbn(num_classes, pretrained=False, **kwargs):
