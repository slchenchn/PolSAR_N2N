...
class GAU(nn.Module):
    ...
    def forward(self, input_low, input_high):
        ...
        upsample_low = nn.functional.interpolate(input_low, high_size, mode='bilinear')
...
class FPA(nn.Module):
    ...
    def forward(self, x):
        ...
        x_gp = nn.functional.interpolate(x_gp, size=input_size, mode='bilinear')
...
class MV3_1_true_2_ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = nn.functional.interpolate(x, ori_size, mode='bilinear')
...
def MV3_1_true_2_ResNet50(num_classes, pretrained=True, **kwargs):
