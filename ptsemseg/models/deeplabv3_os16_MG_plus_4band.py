...
class DeepLabV3_MG_plus_4band(nn.Module):
    # def __init__(self, num_classes,model_id, project_dir):
    def __init__(self, num_classes):
        super(DeepLabV3_MG_plus_4band, self).__init__()
        ...
        self.fitst_layer = nn.Conv2d(in_channels=4, out_channels=3, kernel_size=1)
        ...
        low_channel=48
        normal_channel=256
        self.decoder=decoder_4band(low_channel,normal_channel,self.num_classes)
...
class decoder_4band(nn.Module):
    def __init__(self,low_channel,normal_channel,num_classes):
        super(decoder_4band,self).__init__()
