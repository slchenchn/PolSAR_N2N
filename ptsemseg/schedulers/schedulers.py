...
def PolynomialLR_chen(optimizer, max_iter, gamma=0.9, last_epoch=-1):
    get_lr = lambda epoch: 1-(epoch/max_iter)**gamma
    schedular = LambdaLR(optimizer, lr_lambda=get_lr, last_epoch=last_epoch)
    return schedular
